...
from wlink.auth.packets import ChallengeRequest, ProofRequest, RealmlistRequest, Response
from wlink.auth.packets.b12340.challenge import make_challenge_response, ChallengeResponse
from wlink.auth.packets.b12340.proof import make_proof_response, ProofResponse
from wlink.auth.packets.b12340.realmlist import make_realmlist_response, RealmlistResponse
...
async def auth_server(stream):
	...
	await auth.send_packet(ChallengeResponse, make_challenge_response(
		generator=generator,
		prime=prime,
	...
	await auth.send_packet(ProofResponse, make_proof_response(session_proof_hash=actual_session_proof_hash, response=Response.success))
