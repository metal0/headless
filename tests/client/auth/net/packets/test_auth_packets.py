...
def test_challenge_request_packet1():
	...
	assert challenge_request.opcode == auth.net.Opcode.login_challenge
	assert challenge_request.response == auth.net.Response.db_busy
...
def test_challenge_request_packet2():
	...
	assert challenge_request.opcode == auth.net.Opcode.login_challenge
	assert challenge_request.response == auth.net.Response.success
	assert challenge_request.game == 'WoW'
	assert challenge_request.version == '3.3.5'
	assert challenge_request.build == 12340
	assert challenge_request.architecture == 'x86'
...
def test_challenge_response_packet1():
	...
	assert challenge_response.response == auth.net.Response.success
...
def test_challenge_response_packet2():
	...
	challenge_response = packets.ChallengeResponse.parse(packet)
	assert challenge_response.opcode == auth.net.Opcode.login_challenge
	assert challenge_response.response == auth.net.Response.success
...
def test_proof_request_packet1():
	...
	assert proof_request.opcode == auth.net.Opcode.login_proof
...
def test_proof_response_packet1():
	...
	assert proof_response.opcode == auth.net.Opcode.login_proof
	assert proof_response.response == auth.net.Response.success
