...
def test_world_auth_packet():
	...
	auth_challenge = pont.world.net.packets.SMSG_AUTH_CHALLENGE.parse(data)
	...
	auth_session = pont.world.net.packets.CMSG_AUTH_SESSION.parse(data1)
	print(auth_session)
	...
	auth_session3 = pont.world.net.packets.CMSG_AUTH_SESSION.parse(data2)
	...
	print(pont.world.net.packets.CMSG_AUTH_SESSION.parse(data3))
...
def test_world_auth_packets2():
	...
	pont_packet = pont.world.net.packets.CMSG_AUTH_SESSION.build(session_args)
	pont_session = pont.world.net.packets.CMSG_AUTH_SESSION.parse(pont_packet)
...
def test_auth_response():
	...
	packet = pont.world.net.packets.SMSG_AUTH_RESPONSE.parse(data)
