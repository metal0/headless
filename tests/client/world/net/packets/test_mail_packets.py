...
from pont.client.world.net.packets import CMSG_GET_MAIL_LIST, SMSG_MAIL_LIST_RESULT
from pont.client.world.net.packets.mail_packets import MailType


async def test_CMSG_GET_MAIL_LIST():
...
async def test_SMSG_MAIL_LIST_RESULT():
